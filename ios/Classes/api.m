...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.total ? self.total : [NSNull null]), @"total", (self.read ? self.read : [NSNull null]), @"read", (self.undelivered ? self.undelivered : [NSNull null]), @"undelivered", (self.delivered ? self.delivered : [NSNull null]), @"delivered", (self.failed ? self.failed : [NSNull null]), @"failed", (self.sent ? self.sent : [NSNull null]), @"sent", (self.code ? self.code : [NSNull null]), @"code", nil];
}
@end
